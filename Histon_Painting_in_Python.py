...
tim.penup()
tim.hideturtle()
colors_rgb = color_list = [(202, 164, 109), (238, 240, 245), (150, 75, 49), (223, 201, 135), (52, 93, 124),
...
tim.setheading(0)
number_of_dots = 100
number_of_rows_and_columns = 10

# Mine

for i in range(1, number_of_rows_and_columns+1):
